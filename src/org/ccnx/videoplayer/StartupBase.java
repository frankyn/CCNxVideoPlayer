...
public abstract class StartupBase extends Activity {
	...
	protected String CCN_IP="";
	protected int CCN_PORT=9695;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		CCN_IP = incomingIntent.getStringExtra("ccn_ip");
		CCN_PORT = Integer.parseInt(incomingIntent.getStringExtra("ccn_port"));
	...
	protected void setupFace() throws CCNDaemonException {
		...
		postToUI("Using: "+CCN_IP+":"+CCN_PORT);
		//SimpleFaceControl.getInstance(_handle).openMulicastInterface();
		SimpleFaceControl.getInstance(_handle).connectUdp(CCN_IP);	
